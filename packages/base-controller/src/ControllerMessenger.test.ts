...
describe('ControllerMessenger', () => {
  ...
  it('registers and calls action handler with no parameters', () => {
  ...
  it('registers and calls action handler with multiple parameters', () => {
    type MessageAction = {
      type: 'message';
  ...
  it('throws on action call after actions reset', () => {
    type PingAction = { type: 'ping'; handler: () => void };
    const controllerMessenger = new ControllerMessenger<PingAction, never>();
