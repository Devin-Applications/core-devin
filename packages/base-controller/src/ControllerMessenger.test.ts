...
describe('ControllerMessenger', () => {
  ...
  it('registers and calls multiple different action handlers', () => {
  ...
  it('registers and calls an action handler with multiple parameters', () => {
    type MessageAction = {
      type: 'message';
  ...
  it('registers and calls an action handler with a return value', () => {
  ...
  it('prevents registering multiple action handlers under the same name', () => {
  ...
  it('publishes multiple different events to subscriber', () => {
    type MessageEvent =
