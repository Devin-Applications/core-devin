...
describe('ControllerMessenger', () => {
  ...
  it('register and call multiple different action handlers', () => {
  ...
  it('register and call action handler with multiple parameters', () => {
    type MessageAction = {
      type: 'message';
  ...
  it('register and call action handler with return value', () => {
  ...
  it('prevents registering multiple action handlers with same name', () => {
  ...
  it('throws on action call after reset', () => {
    type PingAction = { type: 'ping'; handler: () => void };
    const controllerMessenger = new ControllerMessenger<PingAction, never>();
  ...
  it('allows publishing multiple events to subscriber', () => {
    type MessageEvent =
