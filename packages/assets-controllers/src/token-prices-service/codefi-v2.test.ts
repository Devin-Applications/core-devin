...
describe('CodefiTokenPricesServiceV2', () => {
  describe('fetchTokenPrices', () => {
    ...
    it('does not include token price object for token address when price is undefined in token response data', async () => {
      nock('https://price.api.cx.metamask.io')
        .get('/v2/chains/1/spot-prices')
        .query({
          tokenAddresses:
    ...
    it('handles null market data for a token address', async () => {
      nock('https://price.api.cx.metamask.io')
        .get('/v2/chains/1/spot-prices')
        .query({
          tokenAddresses:
