...
describe('TokenListController', () => {
  ...
  it('should update tokenList state on network updates', async () => {
  ...
  it('should poll and update rate correctly', async () => {
  ...
  it('should poll correctly after restart', async () => {
    const tokenListMock = sinon.stub(
      TokenListController.prototype,
      'fetchTokenList',
    );
  ...
  it('should call fetchTokenList on supported network', async () => {
    const tokenListMock = sinon.stub(
      TokenListController.prototype,
      'fetchTokenList',
    );
  ...
  it('should not call fetchTokenList on unsupported network', async () => {
    const tokenListMock = sinon.stub(
      TokenListController.prototype,
      'fetchTokenList',
    );
  ...
  it('should update cache before threshold if data is undefined', async () => {
    nock(tokenService.TOKEN_END_POINT_API)
      .get(getTokensPath(ChainId.mainnet))
      .once()
      .reply(200, undefined);
  ...
  it('should update token list from cache before threshold', async () => {
    const controllerMessenger = getControllerMessenger();
    const messenger = getRestrictedMessenger(controllerMessenger);
    const controller = new TokenListController({
      chainId: ChainId.mainnet,
  ...
  it('should update token list on token property change', async () => {
    nock(tokenService.TOKEN_END_POINT_API)
      .get(getTokensPath(ChainId.mainnet))
      .reply(200, sampleMainnetTokenList)
      .persist();
  ...
  it('should update cache when timestamp expires', async () => {
    nock(tokenService.TOKEN_END_POINT_API)
      .get(getTokensPath(ChainId.mainnet))
      .reply(200, sampleMainnetTokenList)
      .persist();
  ...
  it('should update token list on chainId change', async () => {
    nock(tokenService.TOKEN_END_POINT_API)
      .get(getTokensPath(ChainId.mainnet))
      .reply(200, sampleMainnetTokenList)
  ...
  it('should clear tokenList and tokensChainsCache', async () => {
    const controllerMessenger = getControllerMessenger();
    const messenger = getRestrictedMessenger(controllerMessenger);
    const controller = new TokenListController({
      chainId: ChainId.mainnet,
  ...
  it('should update preventPollingOnNetworkRestart and restart polling', async () => {
    nock(tokenService.TOKEN_END_POINT_API)
      .get(getTokensPath(ChainId.mainnet))
      .reply(200, sampleMainnetTokenList)
      .get(getTokensPath(ChainId.goerli))
  ...
  describe('startPollingByNetworkClient', () => {
    ...
    it('should call fetchTokenListByChainId with correct chainId', async () => {
      nock(tokenService.TOKEN_END_POINT_API)
    ...
    it('should start polling at interval passed to constructor', async () => {
      const fetchTokenListByChainIdSpy = jest.spyOn(
        tokenService,
        'fetchTokenListByChainId',
      );
