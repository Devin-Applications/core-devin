...
describe('getEnvUrls', () => {
  it('returns URLs if given a valid environment', () => {
  ...
  it('throws an error if the environment is invalid', () => {
...
describe('getOidcClientId', () => {
  it('returns client id if given a valid environment and platform', () => {
  ...
  it('throws an error if the platform is invalid', () => {
    expect(() =>
